...
final class NativeWingetBridge implements WingetBridge {
  ...
  @override
  void searchName(int handle, String query, SendPort reply) => using(
    (a) => ffi.wgSearchName(
      handle,
      query.toNativeUtf8(allocator: a).cast(),
      reply.nativePort,
    ),
  );
  ...
  @override
  void simulateUpgrade(int handle, String? packageId, SendPort reply) => using(
    (a) => ffi.wgSimulateUpgrade(
      handle,
