...
final _wgUninstall = _lib
    .lookupFunction<
      ffi.Void Function(ffi.Int64, ffi.Pointer<ffi.Char>, ffi.Int32, ffi.Int64),
      void Function(int, ffi.Pointer<ffi.Char>, int, int)
    >('wg_uninstall');
